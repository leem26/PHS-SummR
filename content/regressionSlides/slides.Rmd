...
author: "Matthew Lee <br><br>Harvard University"
output:
...
- Intuitive, the correlation between a r.v. with itself is $\rho_{X,X} = 1$
...
The standard deviation of our `A.con` or `Y.con` variable is the average distance between each point and their group means. 
